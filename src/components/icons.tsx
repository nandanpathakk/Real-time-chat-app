...
export const Icons = {
    Logo: (props: LucideProps) => (            // this lucideProps type that only allow props that an icon can take       
...
export type Icon = keyof typeof Icons // exporting icons as "litterals"