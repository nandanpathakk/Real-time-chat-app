...
const Login = () => {
    ...
    return <div className="flex md:flex-row flex-col min-h-[100dvh]">
        ...
        <div className="flex-[1.5] bg-[#925FE2] flex flex-col bg-[url('/images/object.svg')] bg-center px-20 w-full">
            <div className="flex flex-col pt-20 md:pt-24 space-y-2">
                <p className="text-4xl sm:text-5xl text-white poppins-bold">Welcome</p>
        ...
        <div className="flex-1 bg-[rgb(28,29,33)] flex flex-col justify-center items-center space-y-5">
            <div className="flex flex-col items-center">
                <h1 className="text-gray-300 text-3xl poppins-bold">Login</h1>
                <p className="text-gray-500 poppins-regular">Secure authentication using Google</p>
            </div>
            <Button isLoading={isLoading} type="button"
                className="max-w-mg mx-auto bg-white text-black hover:bg-gray-300 px-20"
